...
| `display-horizon.ts` | Single wall-clock timer for next start/end display boundary; lifecycle listeners call free-function `republishUiForDisplayTick` + tray force rebuild (no automation) |
