 ...
 *
 * Base motion: slow multi-blob drift + dual rings (Settings + About).
 * About (`.app-icon-aurora--about`) adds entrance bloom, sheen, and a drifting
 * flare — rare surface, delight budget. Motion stays on transform/opacity only.
 */
